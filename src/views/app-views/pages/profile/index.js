...
const ProfileInfo = ({ data: { profile, image, avatarSize } }) => {

	// 	address: null
	// city: null
	// dateOfBirth: null
	// email: "talhakhan5023@gmail.com"
	// fullName: "Talha"
	// id: 11
	// isAdmin: false
	// isVerified: true
							...
							<Row gutter="16">
								...
								<Col xs={24} sm={24} md={8}>
									<Row className="mb-2">
										...
										<Col xs={12} sm={12} md={15}>
											<span className="font-weight-semibold">{profile?.email}</span>
										</Col>
									</Row>
									<Row>
										<Col xs={12} sm={12} md={9}>
										...
										<Col xs={12} sm={12} md={15}>
											<span className="font-weight-semibold">{profile?.phone}</span>
										</Col>
									</Row>
								</Col>
								<Col xs={24} sm={24} md={10}>
									<Row className="mb-2 mt-2 mt-md-0 ">
										...
										<Col xs={12} sm={12} md={15}>
											<span className="font-weight-semibold">{profile?.address}</span>
										</Col>
									</Row>
									<Row className="mb-2">
										<Col xs={12} sm={12} md={9}>
										...
										<Col xs={12} sm={12} md={15}>
											<span className="font-weight-semibold">{profile?.website}</span>
										</Col>
									</Row>
								</Col>
							</Row>
...
function Profile() {
	...
	const data = { profile, image, avatarSize }
	return (
		<>
